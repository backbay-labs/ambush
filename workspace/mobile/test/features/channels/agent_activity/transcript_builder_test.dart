...
import 'package:ambush/features/channels/agent_activity/observer_models.dart';
import 'package:ambush/features/channels/agent_activity/transcript_builder.dart';
...
void main() {
  ...
  test('normalizes ambush tool calls and applies result updates', () {
    final items = buildTranscript([
      _updateFrame(
        seq: 1,
        update: {
    ...
    expect(tool.ambushToolName, 'send_message');
  ...
  test('parses ambush prompt text into user message and metadata', () {
    final items = buildTranscript([
      ObserverFrame(
        seq: 1,
