...
import 'package:ambush/features/channels/sticky_date_header.dart';
...
void main() {
  testWidgets(
    ...
    (tester) async {
      ...
      const channel = MethodChannel('ambush/sticky_date_glass/42');
      ...
      try {
        ...
        expect(nativeView.viewType, 'ambush/sticky_date_glass');
