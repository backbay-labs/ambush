...
public enum AmbushPushTranscriptError: Error, Equatable {
...
///
/// Ground truth: `crates/ambush-push-gateway/tests/vectors/app_attest_transcripts.json`,
...
/// defined by NIP-PL (`https://push.ambush.xyz/v1/...`). It is a cross-route
...
public enum AmbushPushTranscript {
    // MARK: Domains

    public static let enrollDomain = "ambush.push.enroll.v1"
    public static let delegateDomain = "ambush.push.delegate.v1"
    public static let rotateEndpointDomain = "ambush.push.rotate-endpoint.v1"
    public static let revokeDelegationDomain = "ambush.push.revoke-delegation.v1"
    public static let revokeInstallationDomain = "ambush.push.revoke-installation.v1"

    // MARK: Fixed audiences (protocol constants, see type docs)

    public static let enrollAudience = "https://push.ambush.xyz/v1/installations"
    public static let delegateAudience = "https://push.ambush.xyz/v1/delegations"
    public static let rotateEndpointAudience = "https://push.ambush.xyz/v1/installations/endpoint"
    public static let revokeDelegationAudience = "https://push.ambush.xyz/v1/delegations/revoke"
    public static let revokeInstallationAudience = "https://push.ambush.xyz/v1/installations/revoke"
    ...
    /// `ambush.push.enroll.v1` — these exact bytes are the App Attest
    ...
    /// `ambush.push.delegate.v1` — `SHA-256(bytes)` is the assertion
    /// `clientDataHash`.
    ...
    /// `ambush.push.rotate-endpoint.v1` — `SHA-256(bytes)` is the assertion
    /// `clientDataHash`.
    ...
    /// `ambush.push.revoke-delegation.v1` — `SHA-256(bytes)` is the assertion
    /// `clientDataHash`.
    ...
    /// `ambush.push.revoke-installation.v1` — `SHA-256(bytes)` is the assertion
    /// `clientDataHash`.
    ...
    struct CanonicalObject {
        ...
        static func escape(_ s: String, field: String) throws -> String {
            ...
            for scalar in s.unicodeScalars {
                ...
                default: throw AmbushPushTranscriptError.nonASCIIInput(field: field)
                }
            }
            return out
        }
