...
public struct AmbushCommunicationNotificationDescriptor: Equatable, Sendable {
  ...
  public init?(resolution: AmbushPushResolution) {
    ...
    self.init(
      ...
      senderIdentifier: AmbushPushPresentationIdentity.sender(
  ...
  public final class AmbushCommunicationNotificationPresenter {
    ...
    public func present(
      ...
      resolution: AmbushPushResolution,
      completion: @escaping (UNNotificationContent) -> Void
    ) {
      guard let descriptor = AmbushCommunicationNotificationDescriptor(resolution: resolution) else {
    ...
    public static func makeIntent(
      _ descriptor: AmbushCommunicationNotificationDescriptor
    ) -> INSendMessageIntent {
      ...
      if descriptor.conversationDisplayName != nil {
        ...
        if let senderAvatar {
          ...
          // Ambush channels do not have a separate avatar, so use the verified
