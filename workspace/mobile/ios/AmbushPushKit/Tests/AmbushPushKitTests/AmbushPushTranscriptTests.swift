...
/// (`crates/ambush-push-gateway/tests/vectors/app_attest_transcripts.json`)
...
final class AmbushPushTranscriptTests: XCTestCase {
    // MARK: Fixture
    ...
    static let appProfile = "ambush-ios-dogfood"
    ...
    func testEnrollVector() throws {
        try assertMatchesVector("enroll", AmbushPushTranscript.enroll(
    ...
    func testDelegateVector() throws {
        try assertMatchesVector("delegate", AmbushPushTranscript.delegate(
            challengeId: Self.challengeId,
            challenge: Self.challenge,
    ...
    func testRotateEndpointVector() throws {
        try assertMatchesVector("rotate_endpoint", AmbushPushTranscript.rotateEndpoint(
            challengeId: Self.challengeId,
            challenge: Self.challenge,
            installationHandle: Self.installationHandle,
            endpointEpoch: 1,
    ...
    func testRevokeDelegationVector() throws {
        try assertMatchesVector("revoke_delegation", AmbushPushTranscript.revokeDelegation(
            challengeId: Self.challengeId,
            challenge: Self.challenge,
            installationHandle: Self.installationHandle,
            relayPubkey: Self.relayPubkey,
    ...
    func testRevokeInstallationVector() throws {
        try assertMatchesVector("revoke_installation", AmbushPushTranscript.revokeInstallation(
            challengeId: Self.challengeId,
            challenge: Self.challenge,
            installationHandle: Self.installationHandle,
            endpointEpoch: 1,
    ...
    func testSolidusIsNotEscaped() throws {
        ...
        XCTAssertEqual(try AmbushPushTranscript.CanonicalObject.escape("https://push.ambush.xyz/v1", field: "audience"),
                       "https://push.ambush.xyz/v1")
    }

    func testMinimalEscaping() throws {
        XCTAssertEqual(try AmbushPushTranscript.CanonicalObject.escape("a\"b\\c\u{08}\u{09}\u{0A}\u{0C}\u{0D}\u{01}", field: "x"),
                       "a\\\"b\\\\c\\b\\t\\n\\f\\r\\u0001")
    }

    func testNonASCIIRejected() {
        XCTAssertThrowsError(try AmbushPushTranscript.CanonicalObject.escape("caf\u{00E9}", field: "app_profile")) {
            XCTAssertEqual($0 as? AmbushPushTranscriptError, .nonASCIIInput(field: "app_profile"))
        }
    }

    func testUUIDLowercased() throws {
        var o = AmbushPushTranscript.CanonicalObject()
