package com.backbay.ambush.mobile
...
internal class HuddleAudioEngine(
    ...
    fun start() {
        ...
        running.set(true)
        captureThread = thread(name = "ambush-huddle-capture", isDaemon = true) {
            runCapture(record, encoder)
        }
        playbackThread = thread(name = "ambush-huddle-playback", isDaemon = true) {
            runPlayback()
        }
    }
