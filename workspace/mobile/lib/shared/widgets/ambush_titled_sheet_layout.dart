...
class AmbushTitledSheetLayout extends HookWidget {
  const AmbushTitledSheetLayout({
    super.key,
    required this.title,
    required this.child,
    this.leading,
  ...
  Widget build(BuildContext context) {
    ...
    final sheet = SizedBox(
      ...
      child: ColoredBox(
        key: const ValueKey('ambush-sheet-surface'),
        color: paintsSurface ? color : Colors.transparent,
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            DecoratedBox(
              key: const ValueKey('ambush-sheet-scroll-divider'),
    ...
    return ClipRRect(
      key: const ValueKey('ambush-sheet-surface-clip'),
