...
/// Height of an idle [AmbushSearchField].
const double ambushSearchIdleFieldHeight = 45;

/// Font size used for idle [AmbushSearchField] text.
const double ambushSearchIdleTextSize = 15;
...
/// Ambush's global-search text field treatment, shared by search-like inputs.
class AmbushSearchField extends StatelessWidget {
  /// Creates a search field with Ambush's shared styling.
  const AmbushSearchField({
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: searchInputTextStyle.copyWith(
                    ...
                    fontSize: ambushSearchIdleTextSize,
                    height: 20 / ambushSearchIdleTextSize,
                  ),
