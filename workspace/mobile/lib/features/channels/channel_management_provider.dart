...
const bool mockDmDirectoryEnabled =
    kDebugMode && bool.fromEnvironment('AMBUSH_MOCK_DM_DIRECTORY');
...
///
/// Ambush relays use `member` tags, while older NIP-29-compatible relays may
