...
//! `key = sha256(relay_secret_key_bytes || "ambush-invite-v1")`. Rotating the
...
pub use ambush_core::invite::DEFAULT_INVITE_TTL_SECS;

/// Maximum invite lifetime a mint request may ask for: 30 days.
pub use ambush_core::invite::MAX_INVITE_TTL_SECS;
...
const KEY_DERIVATION_LABEL: &[u8] = b"ambush-invite-v1";
