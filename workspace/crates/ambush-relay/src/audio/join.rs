...
//! [`MeshStreamFrame::Data`](ambush_relay_mesh::MeshStreamFrame). Their layout is
...
/// [`MeshStreamFrame::Data`](ambush_relay_mesh::MeshStreamFrame)`.payload`,
...
mod tests {
    ...
    use ambush_relay_mesh::{BoxFuture, StreamRecvHalf, StreamSendHalf};
    ...
    impl RelayPeerTransport for NullTransport {
        ...
        fn set_inbound(&self, _handler: Box<dyn ambush_relay_mesh::InboundHandler>) {}
    }
