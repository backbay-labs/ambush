...
//! from `ambush-conformance`. See `crates/ambush-conformance/src/lib.rs` for
...
///   [`ambush_db::Ambush::communities_of_channels`]). On a hit, return the
...
fn project_row_community(
    ...
    channel_communities: &std::collections::HashMap<Uuid, ambush_core::CommunityId>,
...
/// [`ambush_db::Ambush::communities_of_channels`] over the distinct
/// channel ids in `rows`.
