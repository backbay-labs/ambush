#![deny(unsafe_code)]
#![warn(missing_docs)]
//! NIP-01 WebSocket relay for Ambush private team communication.
...
/// `docs/spec/MultiTenantRelay.tla` by the independent `ambush-conformance`
/// checker.
pub mod conformance;
...
/// Inter-relay mesh startup wiring (`AMBUSH_MESH` seam).
pub mod mesh_boot;
...
/// Workflow action sink — relay-side implementation of [`ambush_workflow::ActionSink`].
