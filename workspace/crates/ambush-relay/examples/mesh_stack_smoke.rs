...
//!
//! Crash report (2026-07-08, ambush-desktop 0.3.46): enabling Share compute
...
//!
//!   cargo run -p ambush-relay --example mesh_stack_smoke
...
/// Must match `ambush_lib::mesh_llm::MESH_WORKER_STACK_SIZE` (desktop crate is
/// not a dependency of ambush-relay, so the value is duplicated here).
