...
//!
//! ambush-agent asks the client to authorize every LLM-issued MCP tool call
//! *before* executing it; the client applies `AMBUSH_ACP_PERMISSION_POLICY` and
...
//!   (`AMBUSH_AGENT_MAX_PENDING_PERMISSIONS`) acquired *before* any correlation
