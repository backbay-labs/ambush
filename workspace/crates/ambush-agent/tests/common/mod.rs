//! Shared subprocess test harness for the ambush-agent ACP integration suites.
//!
...
//!
//! It drives a real `ambush-agent` child over the ACP wire against a fake LLM
...
/// `session/request_permission` response. Mirrors ambush-acp's answering side,
