...
//! `AMBUSH_MEDIA_UPLOAD_RECORDS`. IP collection is a second, independent opt-in
//! (`AMBUSH_MEDIA_UPLOAD_IP_HEADER`) and is *fail-empty*: a missing, malformed,
...
//!
//! ## Consumer contract (ambush-moderation)
//!
...
pub struct UploadRecord {
    ...
    /// Present only when `AMBUSH_MEDIA_UPLOAD_IP_HEADER` is set AND the header
