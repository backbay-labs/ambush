//! Immutable capabilities for Ambush Desktop's April Pocket TTS bundle.
...
/// Capabilities of Ambush Desktop's sole Pocket model.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
...
/// Return immutable metadata for Ambush Desktop's April INT8 model.
