#![deny(unsafe_code)]
#![warn(missing_docs)]
//! Ambush search — community-scoped Postgres full-text search over Ambush events.
//!
...
//! by `ambush-db`. The relay refetches canonical events through `ambush-db`'s
...
pub use ambush_core::CommunityId;
