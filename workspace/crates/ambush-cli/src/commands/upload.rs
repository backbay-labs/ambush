...
pub async fn dispatch(cmd: crate::UploadCmd, client: &AmbushClient) -> Result<(), CliError> {
    match cmd {
...
pub async fn dispatch_media(cmd: crate::MediaCmd, client: &AmbushClient) -> Result<(), CliError> {
    match cmd {
