...
pub fn sdk_err(e: ambush_sdk::SdkError) -> CliError {
    match e {
        ambush_sdk::SdkError::InvalidInput(msg) => CliError::Usage(msg),
...
mod tests {
    ...
    // and `normalize_mention_pubkeys` live in `ambush_sdk::mentions` and are tested there.
