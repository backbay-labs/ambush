...
/// trace schema.
///
/// This deliberately does NOT reuse `ambush_core::CommunityId`. Two reasons:
///
/// 1. **Production fence preservation.** `ambush_core::CommunityId` has no
...
impl CommunityLabel {
    /// Wrap a UUID into a community label. Unlike `ambush_core::CommunityId`
