...
///   `str_ends_with`, `str_len` (duplicated intentionally from ambush-workflow).
...
/// `str_len` — duplicated from ambush-workflow intentionally so this crate
/// has no runtime dependency on ambush-workflow.
