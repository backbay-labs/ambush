...
pub const CACHE_INVALIDATION_PATTERN: &str = "ambush:*:cache-invalidate";
...
pub fn cache_invalidation_channel(ctx: &TenantContext) -> String {
    format!(
        "{AMBUSH_PREFIX}:{}:{CACHE_INVALIDATION_SUFFIX}",
        ctx.community()
    )
}
...
/// Subscribes to `ambush:*:cache-invalidate` and forwards scoped drops to the broadcast.
///
...
mod tests {
    ...
    fn cache_invalidation_channel_is_community_scoped() {
        ...
        assert_eq!(
            ...
            format!("ambush:{}:cache-invalidate", community_a.community())
        );
        assert_ne!(
            cache_invalidation_channel(&community_a),
    ...
    fn parses_cache_invalidation_channel() {
        ...
        let raw = format!("ambush:{community_id}:cache-invalidate");
    ...
    fn rejects_bad_cache_invalidation_channels() {
        for raw in [
            "ambush:cache-invalidate",
            "ambush:not-a-uuid:cache-invalidate",
            "not-ambush:00000000-0000-0000-0000-00000000aaaa:cache-invalidate",
            "ambush:00000000-0000-0000-0000-00000000aaaa:cache-invalidate:extra",
            "ambush:00000000-0000-0000-0000-00000000aaaa:channel:00000000-0000-0000-0000-00000000bbbb",
        ] {
