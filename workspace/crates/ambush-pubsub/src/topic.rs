...
/// Redis key prefix for Ambush-scoped pub/sub topics and keys.
pub const AMBUSH_PREFIX: &str = "ambush";
    ...
    pub fn redis_channel(&self) -> String {
        match self.topic {
            EventTopic::Channel(channel_id) => {
                format!("{AMBUSH_PREFIX}:{}:channel:{channel_id}", self.community_id)
            }
            EventTopic::Global => format!("{AMBUSH_PREFIX}:{}:global", self.community_id),
        }
    }
...
mod tests {
    ...
    fn channel_key_includes_community_and_channel() {
        ...
        assert_eq!(
            ...
            format!("ambush:{}:channel:{channel_id}", ctx.community())
        );
    }
    ...
    fn global_key_includes_community() {
        ...
        assert_eq!(
            global_key(&ctx),
            format!("ambush:{}:global", ctx.community())
        );
    }
    ...
    fn parses_channel_topic() {
        ...
        let channel_id = Uuid::from_u128(0xbbbb);
        let raw = format!("ambush:{community_id}:channel:{channel_id}");
    ...
    fn parses_global_topic() {
        let community_id = CommunityId::from_uuid(Uuid::from_u128(0xaaaa));
        let raw = format!("ambush:{community_id}:global");
    ...
    fn rejects_malformed_or_wrong_prefix_topics() {
        for raw in [
            "",
            "not-ambush:00000000-0000-0000-0000-00000000aaaa:global",
            "ambush:not-a-uuid:global",
            "ambush:00000000-0000-0000-0000-00000000aaaa",
            "ambush:00000000-0000-0000-0000-00000000aaaa:global:extra",
            "ambush:00000000-0000-0000-0000-00000000aaaa:channel",
            "ambush:00000000-0000-0000-0000-00000000aaaa:channel:not-a-uuid",
            "ambush:00000000-0000-0000-0000-00000000aaaa:presence:abc",
        ] {
            assert!(
