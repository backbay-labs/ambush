...
/// this private supertrait, so no external `ambush_auth` consumer can implement
...
///
/// ```compile_fail
/// use ambush_auth::AssertionKeySet;
...
/// outside `ambush_auth`. That closes the authority-construction seam: an
...
///
/// ```compile_fail
/// use ambush_auth::{AssertionKeySet, IssuerKeySource};
/// struct Forge;
