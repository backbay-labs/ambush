...
//! (AMBUSH-SEC-007 class, reported 2026-07-27).
//!
...
//!   DATABASE_URL=postgres://ambush:ambush_dev@localhost:5432/ambush_relay_admin_regression \
//!   cargo test -p ambush-test-client --test regression_relay_admin_ban_gate \
//!     -- --ignored --nocapture
