...
//!
//! ```text
//! cargo test -p ambush-test-client --test e2e_media -- --ignored --nocapture
//! ```
//!
//! Override the relay URL:
//!
//! ```text
//! RELAY_HTTP_URL=http://localhost:3000 cargo test -p ambush-test-client --test e2e_media -- --ignored
//! ```
