...
//! Minimal NIP-01 WebSocket test client for the Ambush relay.
...
use ambush_ws_client::NostrWsConnection;
pub use ambush_ws_client::{parse_relay_message, OkResponse, RelayMessage, WsClientError};

/// Errors returned by [`AmbushTestClient`] operations.
#[derive(Debug, Error)]
...
/// WebSocket test client for integration testing against a running Ambush relay.
pub struct AmbushTestClient {
    inner: NostrWsConnection,
}

impl AmbushTestClient {
