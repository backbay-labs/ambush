...
impl Db {
    ...
    /// request/connection error. ambush-db only reads the durable host map.
    ...
    /// fully-formed [`ambush_core::tenant::TenantContext`] — host included — to
    ...
    ///
    /// Used by the runtime conformance read-seam emitters in `ambush-relay`:
