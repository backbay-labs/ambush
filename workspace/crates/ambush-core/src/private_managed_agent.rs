...
pub const FORMAT: &str = "ambush-private-managed-agent";
...
mod tests {
    ...
    fn projection_hash_fixture_is_stable() {
        assert_eq!(
            content_sha256(b"ambush-private-managed-agent-v1"),
            "e5fb532d5ae8f341e37f1c6e68acf7c0d8395de6abec182e9e15f1df3b43b22d"
        );
    }
}
