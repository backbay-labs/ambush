...
```bash
tamarin-prover --prove crates/ambush-core/src/pairing/NIP-AB.spthy
```
...
Implementations MUST validate against these vectors. They can be reproduced with `ambush-pair test-vectors`.
