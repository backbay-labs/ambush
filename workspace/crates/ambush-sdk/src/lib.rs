#![deny(unsafe_code)]
#![warn(missing_docs)]
//! `ambush-sdk` — typed Nostr event builders for Ambush operations.
//!
//! # Mental Model
//!
//! ```text
...
/// Re-export kind constants so consumers don't need ambush-core directly.
pub use ambush_core::kind;
...
pub use ambush_core::channel::canonical_channel_name;
/// Channel type.
pub use ambush_core::channel::ChannelType as ChannelKind;
/// Channel visibility.
pub use ambush_core::channel::ChannelVisibility as Visibility;
/// Member role.
