...
fn endpoint_fingerprint(profile: AppProfile, token: &[u8]) -> [u8; 32] {
    ...
    h.update(b"ambush-apns-endpoint-v1\0");
...
async fn enroll(State(s): State<AppState>, body: Bytes) -> Response {
    ...
    if r.app_profile != AppProfile::AmbushIosDogfood {
    ...
    let t = EnrollTranscript {
        v: r.v,
        audience: "https://push.ambush.xyz/v1/installations",
    ...
    let signed = match transcript("ambush.push.enroll.v1", &t) {
        Some(v) => v,
        None => return error(StatusCode::BAD_REQUEST, "invalid_request"),
    };
    let verified =
...
async fn verify_installation_assertion<T: serde::Serialize>(
    ...
    if installation.profile != AppProfile::AmbushIosDogfood {
...
async fn delegate(State(s): State<AppState>, body: Bytes) -> Response {
    ...
    let t = DelegateTranscript {
        v: r.v,
        audience: "https://push.ambush.xyz/v1/delegations",
        challenge_id: r.challenge_id,
        challenge: &r.challenge,
...
async fn rotate_endpoint(State(s): State<AppState>, body: Bytes) -> Response {
    ...
    let t = RotateTranscript {
        v: r.v,
        audience: "https://push.ambush.xyz/v1/installations/endpoint",
        challenge_id: r.challenge_id,
        challenge: &r.challenge,
        installation_handle: r.installation_handle,
        endpoint_epoch: r.endpoint_epoch,
    ...
    if let Err(e) = verify_installation_assertion(
        ...
        &r.challenge,
        &r.assertion,
        "ambush.push.rotate-endpoint.v1",
        &t,
    )
    .await
    {
...
async fn revoke_delegation(State(s): State<AppState>, body: Bytes) -> Response {
    ...
    let t = RevokeDelegationTranscript {
        v: r.v,
        audience: "https://push.ambush.xyz/v1/delegations/revoke",
        challenge_id: r.challenge_id,
        challenge: &r.challenge,
        installation_handle: r.installation_handle,
        relay_pubkey: &r.relay_pubkey,
    ...
    if let Err(e) = verify_installation_assertion(
        ...
        &r.challenge,
        &r.assertion,
        "ambush.push.revoke-delegation.v1",
        &t,
    )
    .await
    {
...
async fn revoke_installation(State(s): State<AppState>, body: Bytes) -> Response {
    ...
    let t = RevokeInstallationTranscript {
        v: r.v,
        audience: "https://push.ambush.xyz/v1/installations/revoke",
        challenge_id: r.challenge_id,
        challenge: &r.challenge,
        installation_handle: r.installation_handle,
        endpoint_epoch: r.endpoint_epoch,
    ...
    if let Err(e) = verify_installation_assertion(
        ...
        &r.challenge,
        &r.assertion,
        "ambush.push.revoke-installation.v1",
        &t,
    )
    .await
    {
...
async fn deliver(State(s): State<AppState>, headers: HeaderMap, body: Bytes) -> Response {
    ...
    if permit.authority.profile != AppProfile::AmbushIosDogfood {
...
mod request_limit_tests {
    ...
    fn state() -> AppState {
        let app_attest = AppAttestVerifier::new(
            "TEAMID.com.backbay.ambush.dogfood.mobile".to_owned(),
        ...
        AppState {
            ...
            delivery_url: "https://push.ambush.xyz/v1/deliveries/apns"
                .parse()
                .unwrap(),
    ...
    fn maximum_enrollment_body() -> Vec<u8> {
        serde_json::to_vec(&InstallationEnrollRequest {
            ...
            app_profile: AppProfile::AmbushIosDogfood,
...
mod transcript_vector_tests {
    ...
    fn enroll_transcript_vector() {
        ...
        assert_vector("enroll", &transcript("ambush.push.enroll.v1", &t).unwrap());
    }
    ...
    fn delegate_transcript_vector() {
        ...
        assert_vector(
            "delegate",
            &transcript("ambush.push.delegate.v1", &t).unwrap(),
        );
    }
    ...
    fn rotate_endpoint_transcript_vector() {
        ...
        assert_vector(
            "rotate_endpoint",
            &transcript("ambush.push.rotate-endpoint.v1", &t).unwrap(),
        );
    }
    ...
    fn revoke_delegation_transcript_vector() {
        ...
        assert_vector(
            "revoke_delegation",
            &transcript("ambush.push.revoke-delegation.v1", &t).unwrap(),
        );
    }
    ...
    fn revoke_installation_transcript_vector() {
        ...
        assert_vector(
            "revoke_installation",
            &transcript("ambush.push.revoke-installation.v1", &t).unwrap(),
        );
    }
}
