...
tags: [nostr, nip-rs, read-state, formal-model, ambush]
status: active
created: 2026-07-16
---
...
(below): every context ID Ambush actually generates (channel UUID,
...
**Cost:** zero bytes for every context ID Ambush generates today (channel
...
">256-byte key drop hazard" section: Ambush's own key shapes cannot
