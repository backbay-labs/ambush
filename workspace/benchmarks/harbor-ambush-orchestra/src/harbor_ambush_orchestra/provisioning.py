"""Typed boundary between the Harbor adapter and Ambush trial provisioning."""
...
class AgentCredential:
    """One trial-scoped Ambush identity and attributed LLM credential."""
...
class DirectoryIdentity:
    """One public, benchmark-seeded identity discoverable through Ambush."""
...
@dataclass(frozen=True, slots=True)
class TrialHandle:
    """Provisioned Ambush resources owned by one Harbor trial."""
    ...
    user_relay_url: str = ""
    # Additive Ambush-native task context. Directory entries contain no secrets.
    task_name: str = ""
...
class TrialProvisioner(Protocol):
    """Creates and tears down trial-isolated Ambush resources synchronously."""
