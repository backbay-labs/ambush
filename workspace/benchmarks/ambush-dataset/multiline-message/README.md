...
must survive the `ambush messages send` shell call as real newline bytes. The
...
[backbay-labs/ambush#5787](https://github.com/backbay-labs/ambush/issues/5787).

Run with the command in the parent [README](../README.md), replacing the task
path with `benchmarks/ambush-dataset/multiline-message`.
