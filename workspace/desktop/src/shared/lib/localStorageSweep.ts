...
export const LOCAL_STORAGE_SWEEP_RULES: readonly LocalStorageSweepRule[] = [
  { keyPrefix: "ambush-channel-messages.v1:", maxAgeMs: 14 * DAY_MS },
  { keyPrefix: "ambush-channels.v1:", maxAgeMs: 14 * DAY_MS },
  { keyPrefix: "ambush-observed-unread.v1:", maxAgeMs: 14 * DAY_MS },
  { keyPrefix: "ambush-sidebar-skeleton-shape.v1:", maxAgeMs: 14 * DAY_MS },
  { keyPrefix: "ambush-timeline-skeleton-shape.v1:", maxAgeMs: 14 * DAY_MS },
  { keyPrefix: "ambush-user-labels.v1:", maxAgeMs: 14 * DAY_MS },
  // Do not add ambush-self-profile.v1: here. It is the load-bearing offline
