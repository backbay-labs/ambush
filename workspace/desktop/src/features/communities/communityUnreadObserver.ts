...
const participationStore = makeRootIdStore("ambush-thread-participation.v1");
const authoredStore = makeRootIdStore("ambush-thread-authored.v1");
const mutedRootsStore = makeRootIdStore("ambush-thread-muted.v1");
const FOLLOWS_STORAGE_KEY_PREFIX = "ambush-thread-follows.v1";
