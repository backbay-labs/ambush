 ...
 *  tree transitively imports a .css file (AmbushLogoAnimation.tsx →
 *  ambush-logo-animation.css) and the test-loader has no CSS stub. The
...
// AmbushLogoAnimation.tsx → ambush-logo-animation.css). The test below verifies the
