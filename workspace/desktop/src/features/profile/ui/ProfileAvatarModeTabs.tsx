      ...
      >
        <div
          ...
          className={cn(
            ...
            isOnboardingModal
              ? "bg-[rgb(var(--ambush-onboarding-avatar-action-bg))]"
              : "bg-background",
          )}
          style={{
        ...
        {MODE_TAB_ORDER.map((tabMode) => (
          <TabsTrigger
            className={cn(
              isOnboardingModal
                ? "relative z-10 h-full rounded-full bg-transparent px-4 text-sm font-normal shadow-none transition-colors data-[state=active]:bg-transparent data-[state=active]:text-[rgb(var(--ambush-onboarding-avatar-action-fg))] data-[state=active]:shadow-none"
