...
import { getAmbushToolInfo } from "../agentSessionToolCatalog";
...
export function ToolItem({
  ...
  const canonicalToolName = item.ambushToolName ?? item.toolName;
  const ambushTool = getAmbushToolInfo(canonicalToolName);
