 ...
 * mirroring the Rust interpreter in `crates/ambush-agent/src/model_capabilities.rs`
...
/** Valid thinking-effort values accepted by ambush-agent (mirrors parse_thinking_effort in config.rs). */
