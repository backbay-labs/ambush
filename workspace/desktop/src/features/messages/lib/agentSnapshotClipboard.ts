...
const CLIPBOARD_ATTRIBUTE = "data-ambush-agent-snapshot";
...
/** Build Ambush-specific clipboard HTML with the raw URL as its visible link. */
...
/** Convert an Ambush snapshot clipboard payload into one pending attachment. */
