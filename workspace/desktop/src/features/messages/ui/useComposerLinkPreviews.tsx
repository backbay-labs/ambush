...
function ComposerLinkPreviewCard({
  ...
  // External cards are send-ready only once their snapshot tag exists. Ambush
  ...
  const done = snapshotTagReady || isAmbushEntityPreview(preview);
