...
export function MessageThreadPanel({
  ...
  const threadScrollRegion = (
    <AuxiliaryPanelBody
      ...
      data-ambush-conversation-scroll
    ...
    <>
      {!isAtBottom ? (
        <div className="pointer-events-none absolute inset-x-0 bottom-36 z-50 flex justify-center px-4">
          <Button
            className="pointer-events-auto h-7 min-h-7 gap-1.5 rounded-full border-border/50 bg-background px-2.5 text-2xs font-medium text-muted-foreground hover:bg-muted/70 hover:text-foreground [&_svg]:size-4"
