    ...
    >
            ...
            <label className="block w-full" htmlFor="invite-input">
              ...
              <span className={ONBOARDING_KEY_ROW_CLASS}>
                <input
                  ...
                  className={cn(
                    ONBOARDING_KEY_TEXT_CLASS,
                    "block border-0 bg-transparent p-0 text-center shadow-none outline-none placeholder:text-[var(--ambush-onboarding-backup-ink)] placeholder:opacity-40 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
                  )}
      ...
      {isOnboardingSpotlight ? (
        <p
          ...
          aria-live="polite"
          className={cn(
            "absolute top-[calc(100%+2rem)] mt-4 min-h-5 w-full max-w-4xl text-center text-sm text-[color:var(--ambush-onboarding-backup-ink)] transition-opacity duration-150 ease-out",
