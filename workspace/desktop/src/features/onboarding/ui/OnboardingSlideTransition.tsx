...
export function OnboardingSlideTransition({
  ...
  return (
    <div
      className={cn("ambush-onboarding-slide w-full", containerClassName)}
      key={transitionKey}
      {...props}
    >
      <TransitionLine
...
function TransitionLine({
  ...
  return (
    <div
      className="ambush-onboarding-transition-line flex w-full justify-center"
      data-onboarding-direction={direction}
      data-onboarding-effect={effect}
    >
      <div
        className={cn(
          "ambush-onboarding-transition-content w-full",
          contentClassName,
        )}
      >
        {children}
