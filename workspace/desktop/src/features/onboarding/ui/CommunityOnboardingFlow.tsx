...
const NEUTRAL_EMOJI_PICKER_THEME_VARS = {
  "--ambush-emoji-picker-rgb-background":
    "var(--ambush-onboarding-emoji-picker-background)",
  "--ambush-emoji-picker-rgb-color":
    "var(--ambush-onboarding-emoji-picker-color)",
  "--ambush-emoji-picker-rgb-input":
    "var(--ambush-onboarding-emoji-picker-input)",
...
export function CommunityOnboardingFlow({
  ...
  return (
    <div
      className={cn(
        "ambush-onboarding-neutral-theme ambush-startup-shell flex h-dvh justify-center overflow-y-auto px-4 text-foreground",
        ...
        >
          <div
            className={cn(
              ...
              isProfileStage
                ? "ambush-onboarding-step-frame flex max-w-[500px] flex-col items-center"
                : isTeamStage
                  ? "ambush-onboarding-step-frame flex max-w-[760px] flex-col items-center"
            ...
            transaction.stage === "connecting" ? (
              ...
              <>
                ...
                <p className="mx-auto mt-3 max-w-[400px] text-sm leading-6 text-foreground/80">
                  Ambush lets you bring multiple agents into the same workspace.
                  Your team will help you get started using Ambush.
                </p>
