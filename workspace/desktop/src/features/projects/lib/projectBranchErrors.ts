/**
 * Relay push-policy denial token for a repository with no `ambush-channel`
 * binding. Declared in Rust as `ambush-core::git_perms::
...
const NO_CHANNEL_BINDING_COPY =
  ...
  "ambush repos bind --id <repo> --channel <channel-uuid>";
