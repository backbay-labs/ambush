...
const PROJECTS_VIEW_MODE_STORAGE_KEY = "ambush.projects.viewMode";
const PROJECTS_FILTER_STORAGE_KEY = "ambush.projects.filter";
const PROJECTS_REPOSITORY_SCOPE_STORAGE_KEY = "ambush.projects.repositoryScope";
const PROJECTS_PULL_REQUEST_SCOPE_STORAGE_KEY =
  "ambush.projects.pullRequestScope";
const PROJECTS_ISSUE_SCOPE_STORAGE_KEY = "ambush.projects.issueScope";
const PROJECTS_SORT_STORAGE_KEY = "ambush.projects.sort";
 ...
 * gates git reads on membership in the repository's bound `ambush-channel`,
