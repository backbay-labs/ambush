...
function RepositoryUnavailableIndicator({
  ...
  const status = {
    authentication: {
      description: "Ambush could not authenticate with this repository.",
      label: "Access failed",
    },
    missing: {
      description: "No git repository was found on the Ambush relay.",
      label: "Uninitialized",
    },
    access: {
      description:
    ...
    network: {
      description: "The Ambush git service could not be reached.",
      label: "Unreachable",
    },
    ref: {
    ...
    unknown: {
      description: "Ambush could not load this repository.",
      label: "Unavailable",
    },
  } satisfies Record<
