...
const SIDEBAR_PROJECTS_FILTER_KEY = "ambush.sidebar.projects.filter";
const SIDEBAR_PROJECTS_SORT_KEY = "ambush.sidebar.projects.sort";
const SIDEBAR_PROJECTS_EXPANDED_KEY = "ambush.sidebar.projects.expanded";
