...
export type InboxItem = {
   ...
   * repository-scoped root for Ambush Git work. Does NOT change when a new reply
...
/**
 * Returns the stable conversation ID for any FeedItem or relay event. Ambush Git
