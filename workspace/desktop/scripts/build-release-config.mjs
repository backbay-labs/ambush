...
//    Both AMBUSH_UPDATER_PUBLIC_KEY and AMBUSH_UPDATER_ENDPOINT are required -
...
const updaterPubkey = process.env.AMBUSH_UPDATER_PUBLIC_KEY;
const updaterEndpoint = process.env.AMBUSH_UPDATER_ENDPOINT;

const missing = [];
if (!updaterPubkey) missing.push("AMBUSH_UPDATER_PUBLIC_KEY");
if (!updaterEndpoint) missing.push("AMBUSH_UPDATER_ENDPOINT");
if (missing.length > 0) {
  console.error(
