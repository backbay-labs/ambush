...
const KUBERNETES_CONFIG = {
  ...
  cpu_request: "1",
  image:
    "ghcr.io/backbay-labs/ambush-sprig:sha-6530b58@sha256:17facfc7608d8ddb33bc056c9aaba1098f4ef6abe5655702fbfd7584d1f74d76",
  inactivity_seconds: 7200,
  memory_limit: "1Gi",
  memory_request: "1Gi",
  namespace: "ambush-agents-gfq7aq",
};
