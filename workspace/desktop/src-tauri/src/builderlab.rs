...
<head>
  ...
  <title>Ambush authentication complete</title>
  <style>
    :root {
      color-scheme: light;
...
<body>
  <main>
    <svg class="bee" viewBox="0 0 466 309" role="img" aria-label="Ambush">
      <defs>
        <mask id="bee-mask">
    ...
    <p>You can close this window and return to Ambush.</p>
  </main>
</body>
</html>"#;
...
pub(crate) async fn get_builderlab_nostr_identity(
    ...
    authenticated_json(
        ...
        &session,
        reqwest::Method::POST,
        "/v1/ambush/nostr-identities/current",
        serde_json::json!({}),
    )
    .await
}
...
pub(crate) async fn bind_builderlab_nostr_identity(
    ...
    let challenge_value = authenticated_json(
        ...
        &session,
        reqwest::Method::POST,
        "/v1/ambush/nostr-identities/challenge",
    ...
    authenticated_json(
        ...
        &session,
        reqwest::Method::POST,
        "/v1/ambush/nostr-identities/verify",
        serde_json::json!({
...
pub(crate) async fn delete_builderlab_nostr_identity(
    ...
    authenticated_json(
        ...
        &session,
        reqwest::Method::POST,
        "/v1/ambush/nostr-identities/delete",
        serde_json::json!({}),
    )
    .await
}
...
pub(crate) async fn check_builderlab_community_name(
    ...
    authenticated_json(
        ...
        &session,
        reqwest::Method::POST,
        "/v1/ambush/communities/availability",
...
pub(crate) async fn unarchive_builderlab_community(
    ...
    authenticated_json(
        ...
        &session,
        reqwest::Method::POST,
        "/v1/ambush/communities/unarchive",
        serde_json::json!({ "community_id": community_id }),
    )
    .await
}
...
pub(crate) async fn transfer_builderlab_community(
    ...
    authenticated_json(
        ...
        &session,
        reqwest::Method::POST,
        "/v1/ambush/communities/transfer",
        serde_json::json!({
...
mod tests {
    ...
    #[test]
    fn auth_complete_page_uses_ambush_brand() {
        for expected in [
            "<title>Ambush authentication complete</title>",
            "#d7d72e",
            "#231e1e",
    ...
    fn login_defaults_to_auth0_login() {
        ...
        assert_eq!(query.get("product").map(String::as_str), Some("ambush"));
        assert_eq!(
