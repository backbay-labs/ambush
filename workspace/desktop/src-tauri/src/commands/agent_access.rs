...
/// probe in the product crate makes it impossible for ambush-releases to validate
...
mod tests {
    #[test]
    #[ignore = "requires AMBUSH_TEST_EXPECTED_AGENT_ACCESS_OWNER_ONLY"]
    fn compiled_policy_matches_expected() {
        let expected = std::env::var("AMBUSH_TEST_EXPECTED_AGENT_ACCESS_OWNER_ONLY")
            .expect("AMBUSH_TEST_EXPECTED_AGENT_ACCESS_OWNER_ONLY must be set")
            .parse::<bool>()
