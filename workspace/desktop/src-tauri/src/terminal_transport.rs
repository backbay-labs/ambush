...
use ambush_terminal::{damage::Frame, Viewport};
use std::fmt;
...
impl FramePublisher {
    ...
    /// teardown, or explicit detach. The caller owns safe Ambush focus recovery.
...
mod tests {
    use super::*;
    use ambush_terminal::damage::{CursorFrame, RowFrame};
