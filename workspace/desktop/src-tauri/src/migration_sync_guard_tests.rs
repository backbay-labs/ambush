...
fn is_dev_data_dir_name_rejects_prod_identifier() {
    assert!(!is_dev_data_dir_name("com.backbay.ambush.app"));
}

#[test]
fn is_dev_data_dir_name_accepts_canonical_dev_identifier() {
    assert!(is_dev_data_dir_name("com.backbay.ambush.app.dev"));
}

#[test]
fn is_dev_data_dir_name_accepts_worktree_dev_identifier() {
    assert!(is_dev_data_dir_name(
        "com.backbay.ambush.app.dev.some-worktree"
    ));
}
...
/// `com.backbay.ambush.app.developer` is a hypothetical prod variant, not a
/// worktree of `com.backbay.ambush.app.dev`.
#[test]
fn is_dev_data_dir_name_rejects_prefix_collision() {
    assert!(!is_dev_data_dir_name("com.backbay.ambush.app.developer"));
}
