# Ambush — Your Project, Your Domain
...
Next to it, a "Connect on Ambush" button.
...
You hit "Connect on Ambush" and the app opens. You're in `#general`. The team is
...
"Connect on Ambush" and they're in the community. No separate onboarding flow. No
...
portable even when the hosting isn't. And you can use Ambush as a collaboration
layer on top of GitHub if that's what makes sense — work in Ambush channels, push
...
Someone picks up the bug. They create a branch. Ambush creates a channel:
...
things are announcements. Some things are essays. Ambush has surfaces for both,
...
Onboarding friction is real — not insurmountable, but real. The "Connect on Ambush"
