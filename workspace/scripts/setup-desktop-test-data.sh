...
DB_HOST="${AMBUSH_DB_HOST:-127.0.0.1}"
DB_PORT="${AMBUSH_DB_PORT:-5432}"
DB_USER="${AMBUSH_DB_USER:-ambush}"
DB_PASS="${AMBUSH_DB_PASS:-ambush_dev}"
DB_NAME="${AMBUSH_DB_NAME:-ambush}"
DB_DOCKER_CONTAINER="${AMBUSH_DB_DOCKER_CONTAINER:-ambush-postgres}"
...
COMMUNITY_HOST="${AMBUSH_COMMUNITY_HOST:-localhost:3000}"
