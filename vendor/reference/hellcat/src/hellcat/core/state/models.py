...
@dataclass
class Issue:
    """Represents a Beads issue with Hellcat extensions."""
    ...
    def from_dict(cls, data: dict[str, Any]) -> Issue:
        ...
        Note: Some issues in .hellcat/issues.jsonl carry an inline ``blocked_by``
        list. This field is intentionally NOT parsed here because dependency
        resolution is handled entirely through .hellcat/deps.jsonl via
