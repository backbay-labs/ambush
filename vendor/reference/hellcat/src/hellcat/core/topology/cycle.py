...
if TYPE_CHECKING:
    from hellcat.core.topology.hsm_dynamics import DynamicsDBProtocol
    from hellcat.core.topology.policy_learner import PolicyLearner
...
class LearnedCyclePolicy(CyclePolicy):
    ...
    def evaluate(
        ...
        from hellcat.core.topology.policy_learner import DecisionRecord
    ...
    def update(
        ...
        from hellcat.core.topology.policy_learner import compute_reward
...
def create_learned_policy(
    ...
    from hellcat.core.topology.policy_learner import PolicyLearner, PolicyLearnerConfig
