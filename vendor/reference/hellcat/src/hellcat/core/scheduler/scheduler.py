...
class Scheduler:
    ...
    def should_speculate(self, issue: Issue, critical_path: list[Issue]) -> bool:
        ...
        from hellcat.core.routing import first_matching_rule
...
class SchedulingSignalsBuilder:
    ...
    def _load_priority_weights(self) -> None:
        ...
        try:
            from hellcat.core.state.priority_hints import PriorityHintStore

            # Resolve state dir: learned_context_dir is usually .hellcat/memory,
            # hints live at .hellcat/state/priority_hints.json
