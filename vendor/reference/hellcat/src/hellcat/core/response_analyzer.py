"""
Ralph-style Response Analyzer for Hellcat Kernel.
...
class ResponseAnalyzer:
    ...
    def __init__(
        ...
        Args:
            learned_context_dir: Path to .hellcat/learned_context/ for loading anti-patterns
    ...
    def _refresh_learned_patterns(self, force: bool = False) -> None:
        ...
        Reads from .hellcat/learned_context/ directory:
