...
def create_sentinel_scheduler_from_config(
    ...
    from hellcat.core.manifests.schema import ShieldSpec
    from hellcat.core.sentinel.range_raids import RangeRaidConfig, RangeRaidsSentinel
    from hellcat.core.sentinel.security import SecurityConfig, SecuritySentinel
    ...
    if range_raids_data.get("enabled", False):
        ...
        raid_config = RangeRaidConfig(
            ...
            runs_dir=raid_cfg_data.get("runs_dir", ".hellcat/runs"),
