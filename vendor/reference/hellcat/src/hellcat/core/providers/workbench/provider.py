...
class WorkbenchProvider(SandboxProvider):
    ...
    def __init__(self, config: dict[str, Any] | None = None):
        ...
        self.workbench_root = Path(self.config.get("workbench_root", ".hellcat/workbenches"))
    ...
    async def create_sandbox(self, ctx: ExecutionContext) -> str:
        ...
        sandbox_path = Path(run_dir) if run_dir else self.workbench_root / sandbox_id
    ...
    def _build_runtime_config(
        ...
        env.setdefault("HELLCAT_RUN_DIR", str(sandbox_path))
        ...
        return SandboxRuntimeConfig(
            ...
            runtime_bin=runtime_cfg.get("runtime_bin"),
            name_prefix=str(runtime_cfg.get("name_prefix", "hellcat-workbench")),
        )
    ...
    async def _run_workbench_score(
        ...
        try:
            ...
            from hellcat.core.gates.workbench_score import main as score_main
