...
from cyntra.core.manifests.schema import create_drill_manifest
from cyntra.core.providers.base import ExecutionContext
from cyntra.core.providers.registry import get_provider
from cyntra.core.sentinel.base import BaseSentinel, SentinelConfig, SentinelSchedule
from cyntra.trust.primitives import finalize_run_artifacts
from cyntra.trust.primitives.defense_pack import PackArtifact, build_pack
...
class RangeRaidsSentinel(BaseSentinel):
    ...
    async def _export_to_splunk(
        ...
        if not config:
            return
        try:
            from cyntra.infra.observability.splunk_hec import SplunkHECConfig, SplunkHECExporter
