...
class ExplorationController:
    ...
    def trap_count(self) -> int:
        """Number of active trap states."""
        return len(self._get_trap_state_ids())

    @property
    def recommended_mode(self) -> str:
        """Get recommended control mode from dynamics analysis."""
