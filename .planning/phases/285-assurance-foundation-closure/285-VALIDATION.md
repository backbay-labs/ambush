...
| 285-04-03A2b1 | 04 | 7 | ASSURE-04, ASSURE-06 | fresh accepted A2a ledger is independently decoded/recomputed before complete-receipt construction and exact capacity-one reservation; invalid, partial, coherent producer-plus-receipt, full, closed, zero/two-capacity, or failed reservation forwards; no Rust-owned NATS handoff; exact 4-path digest ccd00d773edc3826aecd28bf6d451d0d2a5323ee766224e01b5633cb3815070a | NATS-wrapped exact RED and targets with explicit stage inventories, positive A2a-ledger-first validator, compiled producer-plus-receipt coherent mutants with launcher/manifest/tree pins, root-pinned integrity, A2a/A1 projections, exact immutable review/push chain in 285-04-PLAN.md | ⚠️ redesign | ⛔ r36 `8615228` rejected 0/2/0 only for command rows; r37 audit required before execution |
