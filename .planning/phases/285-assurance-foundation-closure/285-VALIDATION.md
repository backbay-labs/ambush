...
| 285-04-03A1 | 04 | 5 | ASSURE-04, ASSURE-06 | real public/private worker state machines; 8 distinct event-derived transition rows plus 1 worker-budget/client-constructor row with `live_nats_grants_proved=false`; executable Rust mutants and non-test debug/release API-absence probes; no live-grant/relay/recovery claim; exact 8-path digest 3b9e0dcdef3b37beb4dd22cfb576cb0f3d72d45e2c87c54042c548dbc4deacd7 | `test "$(git rev-parse HEAD)" = "$PHASE285_PLAN04_TASK03A1_COMMIT" && test "$(git rev-parse "$PHASE285_PLAN04_TASK03A1_COMMIT^{tree}")" = "$PHASE285_PLAN04_TASK03A1_TREE" && test "$(git show "${PHASE285_PLAN04_TASK03A1_COMMIT}:tools/check-phase285-witness-integrity.sh" | shasum -a 256 | awk '{print $1}')" = "$PHASE285_WITNESS_INTEGRITY_LAUNCHER_SHA256" && test "$(git show "${PHASE285_PLAN04_TASK03A1_COMMIT}:tools/fixtures/phase285-witness-integrity.json" | shasum -a 256 | awk '{print $1}')" = "$PHASE285_WITNESS_INTEGRITY_MANIFEST_SHA256" && env PHASE285_WITNESS_INTEGRITY_LAUNCHER_SHA256="$PHASE285_WITNESS_INTEGRITY_LAUNCHER_SHA256" PHASE285_WITNESS_INTEGRITY_MANIFEST_SHA256="$PHASE285_WITNESS_INTEGRITY_MANIFEST_SHA256" PHASE285_SERVICE_CHECKPOINT_TREE="$PHASE285_PLAN04_TASK03A1_TREE" bash tools/check-phase285-witness-integrity.sh --focused-service-checkpoint-deadline` plus immutable-commit path/tree, full-service-path, package, clippy, fmt, shell, diff, review, and post-review push gates in 285-04-PLAN.md | ❌ W0 | ⬜ pending |
| 285-04-03A2 | 04 | 6 | ASSURE-04, ASSURE-06 | four-account/five-principal authenticated dual public/private relay plus separate tree-pinned normal/relay exact private/public 3,000/12,000-ms max-one NATS response-grant gates at fixed 2,500/3,500 and 10,500/12,500-ms schedules, with same-request second-publish server rejection; one bounded suppressed reply and successful replay; preserves A1; exact 13-path delta digest 63891e64631df71736d4a21c852c43cec261b257b2508c10db72d2fc4c04c164 and 14-path cumulative digest 4e6629733654f7b4b6f1233bfaaef96a0fede0368620380c8b97f9d75bb18664 | `test "$(git rev-parse refs/remotes/origin/work/v179-phase285-plan04-task03a1)" = "$PHASE285_PLAN04_TASK03A1_COMMIT" && test "$(git rev-parse refs/remotes/origin/checkpoint/v179-phase285-plan04-task03a1-production)" = "$PHASE285_PLAN04_TASK03A1_COMMIT" && test "$(git rev-parse HEAD)" = "$PHASE285_PLAN04_TASK03A2_COMMIT" && test "$(git rev-parse "$PHASE285_PLAN04_TASK03A2_COMMIT^{tree}")" = "$PHASE285_PLAN04_TASK03A2_TREE" && test "$(git show "${PHASE285_PLAN04_TASK03A2_COMMIT}:tools/check-phase285-witness-integrity.sh" | shasum -a 256 | awk '{print $1}')" = "$PHASE285_WITNESS_INTEGRITY_LAUNCHER_SHA256" && test "$(git show "${PHASE285_PLAN04_TASK03A2_COMMIT}:tools/fixtures/phase285-witness-integrity.json" | shasum -a 256 | awk '{print $1}')" = "$PHASE285_WITNESS_INTEGRITY_MANIFEST_SHA256" && bash tools/with-nats-jetstream.sh env PHASE285_WITNESS_INTEGRITY_LAUNCHER_SHA256="$PHASE285_WITNESS_INTEGRITY_LAUNCHER_SHA256" PHASE285_WITNESS_INTEGRITY_MANIFEST_SHA256="$PHASE285_WITNESS_INTEGRITY_MANIFEST_SHA256" PHASE285_SERVICE_CHECKPOINT_TREE="$PHASE285_PLAN04_TASK03A2_TREE" bash tools/check-phase285-witness-integrity.sh --focused-service-checkpoint-grants && bash tools/with-nats-jetstream.sh --relay-service-checkpoint env PHASE285_WITNESS_INTEGRITY_LAUNCHER_SHA256="$PHASE285_WITNESS_INTEGRITY_LAUNCHER_SHA256" PHASE285_WITNESS_INTEGRITY_MANIFEST_SHA256="$PHASE285_WITNESS_INTEGRITY_MANIFEST_SHA256" PHASE285_SERVICE_CHECKPOINT_TREE="$PHASE285_PLAN04_TASK03A2_TREE" bash tools/check-phase285-witness-integrity.sh --focused-service-checkpoint-relay` plus A1 semantic projection, exact path/tree, strict validation, immutable review, and post-review push gates | ❌ W0 | ⛔ blocked by accepted A1 checkpoint |
| 285-04-03A3 | 04 | 7 | ASSURE-04, ASSURE-06 | 18/18 physical restart/lost-response rows plus coherent abort successor/binding mutants; preserves A1+A2; exact 6-path delta digest 769825832abfff2e80561b7c4692a0aec750699096f094e3ab5c54765726d4ae and 16-path cumulative digest 1decd3b39a6433d9358a10289d6886f67211b2560563b417381273dd1662d614 | `test "$(git rev-parse refs/remotes/origin/work/v179-phase285-plan04-task03a2)" = "$PHASE285_PLAN04_TASK03A2_COMMIT" && test "$(git rev-parse refs/remotes/origin/checkpoint/v179-phase285-plan04-task03a2-production)" = "$PHASE285_PLAN04_TASK03A2_COMMIT" && test "$(git rev-parse HEAD)" = "$PHASE285_PLAN04_TASK03A3_COMMIT" && test "$(git rev-parse "$PHASE285_PLAN04_TASK03A3_COMMIT^{tree}")" = "$PHASE285_PLAN04_TASK03A3_TREE" && test "$(git show "${PHASE285_PLAN04_TASK03A3_COMMIT}:tools/check-phase285-witness-integrity.sh" | shasum -a 256 | awk '{print $1}')" = "$PHASE285_WITNESS_INTEGRITY_LAUNCHER_SHA256" && test "$(git show "${PHASE285_PLAN04_TASK03A3_COMMIT}:tools/fixtures/phase285-witness-integrity.json" | shasum -a 256 | awk '{print $1}')" = "$PHASE285_WITNESS_INTEGRITY_MANIFEST_SHA256" && bash tools/with-nats-jetstream.sh env PHASE285_WITNESS_INTEGRITY_LAUNCHER_SHA256="$PHASE285_WITNESS_INTEGRITY_LAUNCHER_SHA256" PHASE285_WITNESS_INTEGRITY_MANIFEST_SHA256="$PHASE285_WITNESS_INTEGRITY_MANIFEST_SHA256" PHASE285_SERVICE_CHECKPOINT_TREE="$PHASE285_PLAN04_TASK03A3_TREE" bash tools/check-phase285-witness-integrity.sh --focused-service-checkpoint-grants && bash tools/with-nats-jetstream.sh --relay-service-checkpoint env PHASE285_WITNESS_INTEGRITY_LAUNCHER_SHA256="$PHASE285_WITNESS_INTEGRITY_LAUNCHER_SHA256" PHASE285_WITNESS_INTEGRITY_MANIFEST_SHA256="$PHASE285_WITNESS_INTEGRITY_MANIFEST_SHA256" PHASE285_SERVICE_CHECKPOINT_TREE="$PHASE285_PLAN04_TASK03A3_TREE" bash tools/check-phase285-witness-integrity.sh --focused-service-checkpoint-recovery` plus separate A1/A2 projections, exact path/tree, strict validation, immutable review, and post-review push gates | ❌ W0 | ⛔ blocked by accepted A2 checkpoint |
