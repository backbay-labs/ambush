...
| 285-04-03A2b3 | 04 | 9 | ASSURE-04, ASSURE-06 | live four-account relay on accepted A2b1/A2b2 seams; fresh public/private identities; server-bound pre-expiry 3,000/12,000-ms max-one refusal; true origin-relative first-to-second publish delta with delayed-first-response control; exact 11-path direct/cumulative A2a digest 4d9d95a9253af2cede7f42175322169a4deb3fafebc8fb0d58bcb845cd992adf and 14-path Task02 cumulative digest 4e6629733654f7b4b6f1233bfaaef96a0fede0368620380c8b97f9d75bb18664 | r66 exact detached-source/absent-target replay selected executable `3d9d359...`, proved five diagnostic tokens absent, and failed exact FQN 0/1/0/18 after abort-only recreation returned erased `Unavailable`; compiler/runner/transcript hashes frozen; no retry | ◇ banked; unaccepted | refs exact `ed77183`; accepted-source RED now proven; r66 authority consumed |
| 285-04-03A2b3R1 | 04 | 10 | ASSURE-04, ASSURE-06 | exact four-path test-assurance repair/digest 142ddd609045739262806bb564cfa6ec21184175225f4f139f3ea495ab3dde07; typed test-only async-nats outcome; 12-task abort+await; post-drop flush and two-client drain; old public/private connz identity absence; exact new 9-public/3-private subscription sets; no shipping API/error change | compile RED for missing async quiescence seam; ten coherent same-real-seam mutants; fresh absent-target compiler/runner provenance; one live FQN 1/0/0/18; teardown/readiness/outcome/grant/relay receipts; exactly two topology summaries; focused/package/clippy/fmt/diff; direct-child freeze; immutable production review/push | ❌ W0 | ⛔ r67 immutable planning 0/0/0 and push/fetch required |
| 285-04-03A2c | 04 | 11 | ASSURE-04, ASSURE-06 | positive-first independent canonical/typed/causal oracle plus exact 38-name unconditional real-target corpus: four compiled actual reservation-seam mutants plus 34 immutable-live-ledger integration-oracle mutants; ambient selection controls rejected; direct-error mutants forbidden; exact 4-path slice digest 8b37d06097626b9d3f302ea1053ced7852e5553f095c8ead99964c8bca66b6c5 and unchanged 14-path cumulative digest | genuine RED retained; after accepted A2b3R1, exact partial bytes may be replayed onto that parent; every live/Cargo target uses fresh binary provenance and correct candidate tree; 4 compiled mutants use distinct absent targets/source+binary hashes; 34 artifact mutants each run real oracle; observations, grants, relay, deadline, governance/package/static gates, immutable review/push | ◇ stopped/planning correction | three paths uncommitted; no mutation ran; artifact-only reservation rows invalid; A2b3R1 blocks resumption; A3 blocked |
| 285-04-03A3 | 04 | 12 | ASSURE-04, ASSURE-06 | 18/18 physical restart/lost-response rows plus coherent abort successor/binding mutants; preserves A1+A2a+A2b1+A2b2+A2b3R1+A2c; exact 6-path delta digest 769825832abfff2e80561b7c4692a0aec750699096f094e3ab5c54765726d4ae and 16-path cumulative digest 1decd3b39a6433d9358a10289d6886f67211b2560563b417381273dd1662d614 | predecessor A2c origin refs plus single-parent/direct-parent/candidate/tree/hash/scope gates, source preflight, A2a observations, A2b3R1 grants, A2c relay oracle, recovery, A1 deadline, strict immutable review/push chain in 285-04-PLAN.md | ❌ W0 | ⛔ blocked by accepted A2c checkpoint |
| 285-04-03B | 04 | 13 | ASSURE-04, ASSURE-06 | 15/15 top-level plus reads 6/6, accepted restart/lost 18/18, bounds 66/66, rotation/retention 9/9 | both accepted A3 origin refs plus exact single-parent/direct-parent/candidate/tree/hash/scope gates, then immutable task review; push both 03B refs only on `0/0/0`; run the separate outer cumulative command post-push and require its own `0/0/0` before Plan 04/05A advancement | ❌ W0 | ⛔ blocked by accepted A3 checkpoint |
