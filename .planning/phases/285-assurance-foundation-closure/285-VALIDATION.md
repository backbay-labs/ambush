...
| 285-04-03A2b3 | 04 | 9 | ASSURE-04, ASSURE-06 | live four-account relay on accepted A2b1/A2b2 seams; fresh public/private identities; historical 3,000/12,000-ms grant-fit claim invalidated because NATS starts its clock before responder observation; exact 11-path direct digest 4d9d95a9253af2cede7f42175322169a4deb3fafebc8fb0d58bcb845cd992adf and historical 14-path cumulative digest 4e6629733654f7b4b6f1233bfaaef96a0fede0368620380c8b97f9d75bb18664 | r66 exact detached-source/absent-target replay selected executable `3d9d359...`, proved five diagnostic tokens absent, and failed exact FQN 0/1/0/18 after abort-only recreation returned erased `Unavailable`; cumulative review later found 0/5/3 | ◇ banked; unaccepted | refs exact `ed77183`; source RED and architecture blockers proven; r69 required |
| 285-04-03A2b3R1a | 04 | 10 | ASSURE-04, ASSURE-06 | exact seven-path transport slice/digest `272eb9961675aa24a93164825a64c2db7930d1cfa544a520fddd7d085a10e9ab`; `TimedOut|Other -> OutcomeUnknown`, `NoResponders -> Unavailable`; enqueue not publication; real 3,000/12,000-ms pre-poll grant-expiry recovery | real async-nats branches plus public/private held-poll NATS cases; one applied CAS, requester unknown, byte-identical replay, zero second CAS; coherent mapping/clock/enqueue/CAS controls; package/static gates; immutable review; candidate refs only | ❌ W0 | ⛔ r69 planning 0/0/0 and push/fetch required; sole next slice |
| 285-04-03A2b3R1b | 04 | 11 | ASSURE-04, ASSURE-06 | exact eleven-path lifecycle/resource/secret slice/digest `267eee112c5efb3726273d48a8ca7dbea7752f9d6769a445d4304e59e1d5e757`; runner/connection supervision; idempotent bounded SIGINT/SIGTERM drain; 64-worker/1,024-item/512-MiB checked limits; descriptor-bound zeroized secret/config reads | real task/connection/reconnect/slow-consumer/SIGINT/SIGTERM/double-signal controls; count max/max-plus-one and overflow; symlink/link/type/owner/mode/rewrite controls; R1a regressions; immutable review; candidate refs only | ❌ W0 | ⛔ blocked by reviewed R1a candidate |
| 285-04-03A2b3R1c | 04 | 12 | ASSURE-04, ASSURE-06 | exact nine-path CI slice/digest `728d7deb95a36f26a42d97d345ccc45de11141d9c2c95e612f16bc7cea8a47db`; self-contained workspace tests; explicit ignored live/artifact tests; exact current two-bin closure; witness-integrity wiring; unchanged launcher | ordinary `cargo test --workspace`; exact ignored FQNs under real harness; library/current-target dependency modes and mutations; gate-wiring differential; static/actionlint; immutable review and exact hosted run; candidate refs only | ❌ W0 | ⛔ blocked by reviewed R1b candidate |
| 285-04-03A2b3R1d | 04 | 13 | ASSURE-04, ASSURE-06 | exact four-path relay slice/digest `142ddd609045739262806bb564cfa6ec21184175225f4f139f3ea495ab3dde07`; 12-task abort+await; two-client drain; old connz absence; exact new 9/3 subscriptions; correct `NoResponders`/`Other` semantics | ambient-index refusal plus canonical real/clone index pins; fresh absent-target/compiler/executable/exact-argv positive; supervised bounded exact test inventory; one live FQN; 12 coherent compiled controls; R1a-R1c local canonical gates; exact hosted CI; immutable cumulative production review/push | ❌ W0 | ⛔ blocked by reviewed R1c candidate; only R1d can restore accepted production |
