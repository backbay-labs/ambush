...
| 285-04-03A2b1 | 04 | 7 | ASSURE-04, ASSURE-06 | fresh accepted A2a ledger is independently decoded/recomputed before complete-receipt construction and exact capacity-one reservation; invalid, partial, coherent producer-plus-receipt, full, closed, zero/two-capacity, or failed reservation forwards; checker-owned explicit bounded ledger/receipt handoff from internal predicate to external independent decoder; no public test API or Rust-owned NATS lifecycle; exact 4-path digest ccd00d773edc3826aecd28bf6d451d0d2a5323ee766224e01b5633cb3815070a | NATS-wrapped exact RED; one checker-owned two-stage internal-producer/external-decoder invocation; artifact freshness/boundedness/identity/cleanup refusals; compiled coherent two-stage mutants with launcher/manifest/tree pins; root-pinned integrity; A2a/A1 projections; exact immutable review/push chain in 285-04-PLAN.md | ⏸️ frozen | ⛔ r37 execution exposed unexecutable standalone external command; r38 audit required |
| 285-04-03A2b2 | 04 | 8 | ASSURE-04, ASSURE-06 | account/principal-scoped closed topology tuple sets; cardinality-preserving block moves and cross-principal swaps rejected; exact 5-path digest 964b80e1d926ccc78f1e2f487edb84169a01f1cb6a1eadcf3b294c3234ce98ff | exact immutable predecessor identity, root-pinned integrity, all A2b1 controls, exact topology RED, owner-block mutations, A2a/A1 projections, immutable review/push chain in 285-04-PLAN.md | ❌ W0 | ⛔ blocked by accepted A2b1 checkpoint |
| 285-04-03A2b3 | 04 | 9 | ASSURE-04, ASSURE-06 | live four-account relay on accepted A2b1/A2b2 seams; fresh public/private identities; server-bound pre-expiry 3,000/12,000-ms max-one refusal; true origin-relative first-to-second publish delta with delayed-first-response control; exact 11-path direct/cumulative A2a digest 4d9d95a9253af2cede7f42175322169a4deb3fafebc8fb0d58bcb845cd992adf and 14-path Task02 cumulative digest 4e6629733654f7b4b6f1233bfaaef96a0fede0368620380c8b97f9d75bb18664 | exact immutable predecessor identity, root-pinned integrity, all A2b1/A2b2 controls, exact relay RED, observations, grants, relay-positive, deadline, immutable review/push chain in 285-04-PLAN.md | ❌ W0 | ⛔ blocked by accepted A2b2 checkpoint |
| 285-04-03A2c | 04 | 10 | ASSURE-04, ASSURE-06 | positive-first independent canonical/typed/causal oracle plus exact 38-name unconditional real-target corpus, including four complete-receipt reservation-boundary controls; ambient selection controls rejected; direct-error mutants forbidden; exact 4-path slice digest 8b37d06097626b9d3f302ea1053ced7852e5553f095c8ead99964c8bca66b6c5 and unchanged 14-path cumulative digest | predecessor origin refs plus single-parent/direct-parent/candidate/tree/hash/scope gates, RED `service_checkpoint_oracle_positive_and_mutation_inventory_are_non_bypassable`, observations, grants, final `--focused-service-checkpoint-relay`, A1 deadline, governance/package/static gates, immutable review/push chain in 285-04-PLAN.md | ❌ W0 | ⛔ blocked by accepted A2b3 checkpoint |
| 285-04-03A3 | 04 | 11 | ASSURE-04, ASSURE-06 | 18/18 physical restart/lost-response rows plus coherent abort successor/binding mutants; preserves A1+A2a+A2b1+A2b2+A2b3+A2c; exact 6-path delta digest 769825832abfff2e80561b7c4692a0aec750699096f094e3ab5c54765726d4ae and 16-path cumulative digest 1decd3b39a6433d9358a10289d6886f67211b2560563b417381273dd1662d614 | predecessor A2c origin refs plus single-parent/direct-parent/candidate/tree/hash/scope gates, source preflight, A2a observations, A2b3 grants, A2c relay oracle, recovery, A1 deadline, strict immutable review/push chain in 285-04-PLAN.md | ❌ W0 | ⛔ blocked by accepted A2c checkpoint |
| 285-04-03B | 04 | 12 | ASSURE-04, ASSURE-06 | 15/15 top-level plus reads 6/6, accepted restart/lost 18/18, bounds 66/66, rotation/retention 9/9 | both accepted A3 origin refs plus exact single-parent/direct-parent/candidate/tree/hash/scope gates, then immutable task review; push both 03B refs only on `0/0/0`; run the separate outer cumulative command post-push and require its own `0/0/0` before Plan 04/05A advancement | ❌ W0 | ⛔ blocked by accepted A3 checkpoint |
