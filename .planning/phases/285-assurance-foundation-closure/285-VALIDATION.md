...
| 285-04-03A2b3R1d | 04 | 13 | ASSURE-04, ASSURE-06 | exact four-path relay slice/digest `142ddd609045739262806bb564cfa6ec21184175225f4f139f3ea495ab3dde07`; 12-task abort+await; two-client drain; old connz absence; exact new 9/3 subscriptions; correct `NoResponders`/`Other` semantics | fresh absent-target/compiler/executable/exact-argv positive; one live FQN; 12 coherent compiled controls; R1a-R1c local canonical gates; exact hosted CI; immutable cumulative production review/push | ❌ W0 | ⛔ blocked by reviewed R1c candidate; only R1d can restore accepted production |
