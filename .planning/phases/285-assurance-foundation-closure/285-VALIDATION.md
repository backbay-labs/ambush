...
| 285-04-03A2b2 | 04 | 8 | ASSURE-04, ASSURE-06 | exact six-subject init authority; account/principal-scoped closed topology tuple sets; executed Rust projection from actual config independently reconciled with shell projection; 18 isolated config, 3 comparator-deletion, and 4 projection controls; exact 5-path digest 964b80e1d926ccc78f1e2f487edb84169a01f1cb6a1eadcf3b294c3234ce98ff | exact immutable predecessor identity, root-pinned integrity, one NATS-wrapped checker-owned A2b1 plus topology artifact run, 25/25 unique intended-relation controls with vacuous=0, A2a/A1 projections, immutable review/push chain in 285-04-PLAN.md | 🧭 r42 planning review | rejected `a7c4b13` is immutable/unpushed; production frozen; no active clock |
