...
<details>
<summary>Previous milestones (v1.0 through v1.23) -- see MILESTONES.md</summary>

Phases 1-74 shipped across milestones v1.0 through v1.23. Full history in `.planning/MILESTONES.md`.

</details>

### v1.24 Approval Ledger And Quorum Readiness (Complete)
...
- [x] **Phase 75: Approval Set Definition And Signed Ledgers** - Define approval sets with voters and thresholds, create signed ledger artifacts that preserve vote lineage (completed 2026-04-05)
- [x] **Phase 76: Approval Verdict And Receipt Packs** - Assemble local verdicts from ledger entries, export signed receipt packs with approval lineage (completed 2026-04-05)
- [x] **Phase 77: Human Gate And Promotion Integration** - Hold critical-severity candidates in human-approval-pending state, wire quorum requirement and signed votes into promotion records (completed 2026-04-05)
...
Plans:
- [x] 75-01-PLAN.md -- Core approval types, file-backed stores, harness, swarmctl subcommands, and HTTP endpoints
...
Plans:
- [x] 76-01-PLAN.md -- Verdict evaluation, receipt pack types, stores, harness, and swarmctl subcommands
...
Plans:
- [x] 77-01-PLAN.md -- Human approval gate, severity-based pending state, approval reference types, HTTP routes
- [x] 77-02-PLAN.md -- Quorum gate validation, vote/receipt signature verification, swarmctl commands
...
|-------|-----------|----------------|--------|-----------|
| 75. Approval Set Definition And Signed Ledgers | v1.24 | 1/1 | Complete | 2026-04-05 |
| 76. Approval Verdict And Receipt Packs | v1.24 | 1/1 | Complete | 2026-04-05 |
| 77. Human Gate And Promotion Integration | v1.24 | 2/2 | Complete | 2026-04-05 |
