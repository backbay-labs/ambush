...
- [ ] **Phase 184: Runtime Unwrap Audit And Error Types** - Audit and catalog all unwrap/expect sites in swarm-runtime; define typed error enums per module boundary. (PANIC-01, PANIC-02) (planned)
