...
- [ ] **Phase 260: Positive-Feedback Pheromone Recruitment** - High-concentration deposits lower detection thresholds for matching threat classes. (STIGM-01, BASERES-01) (queued)
- [ ] **Phase 261: Inhibitory Escalation Resolution Signaling** - Escalation resolution restores baseline thresholds. (STIGM-02) (queued)
- [ ] **Phase 262: Recruitment Kill-Chain Benchmark** - Measure 20%+ improvement in time-to-alert on kill-chain scenarios and publish sigma-shift bounds. (STIGM-03, BASERES-02) (queued)
- [ ] **Phase 263: Baseline Poisoning Resistance And Staleness Policy** - Implement staleness-based confidence reduction for aged baseline snapshots. (BASERES-03) (queued)
...
---
*Active milestone: v1.73 Stigmergic Feedback Loops And Baseline Resistance*
*Next step: Execute Phase 260.*
