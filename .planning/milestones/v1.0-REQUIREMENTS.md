...
- [x] **AUD-01**: Runtime records a receipt trail for detection, policy, and response decisions
- [x] **AUD-02**: Team can replay an end-to-end detect -> authorize -> execute flow from saved artifacts
- [x] **OPS-01**: Runtime exports structured traces or logs for the critical path
- [x] **OPS-02**: Integration tests cover detect -> substrate -> policy -> response -> receipt
