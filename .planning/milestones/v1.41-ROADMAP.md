...
### v1.41 Deployment And Hardening

**Goal:** Turn the demo-ready runtime into a deployable, operable platform surface with versioned read APIs, Helm deployment, config/init CLI flows, panic-free critical paths, authenticated and TLS-protected serve surfaces, extracted crates, and structured tracing.
**Executable phases:** 132-136

- [x] **Phase 132: Platform API Envelope And Auth Surface** - Added the `/v2/api/*` read surface with cursor envelopes and scoped platform API key auth. (completed 2026-04-08)
- [x] **Phase 133: Asset Posture And Findings Stream Surface** - Exposed host posture summaries and live findings SSE on the versioned platform API. (completed 2026-04-08)
- [x] **Phase 134: Helm Deployment And Config CLI Experience** - Shipped the deployable Helm chart plus `swarmctl validate` and `swarmctl init` workflows. (completed 2026-04-08)
- [x] **Phase 135: Serve-Surface Security And Panic Elimination** - Removed panic-prone defaults, added bearer auth to `/v2/api/*`, and wired optional TLS plus mTLS across both serve surfaces. (completed 2026-04-08)
- [x] **Phase 136: Crate Extraction And Trace Instrumentation** - Extracted `swarm-evolution` and `swarm-cli`, added optional OTLP tracing bootstrap, and stabilized evolution validation replay/shadow artifacts. (completed 2026-04-09)
...
- [ ] **Phase 137: Kitten Mutation And Drift Orchestration** - Add KittenAgent’s multi-tick mutation loop and concept-drift activation logic.
- [ ] **Phase 138: Fitness Evaluation And Population Persistence** - Score candidate genomes on replay corpora and persist the evolving population across restarts.
- [ ] **Phase 139: Formal Safety Gate And Canary Admission** - Verify evolved candidates against repo-owned safety invariants before the canary handoff.
- [ ] **Phase 140: Evolution Observability And Operator Status** - Surface evolution metrics over SSE and `swarmctl evolution status`.
...
- [ ] **Phase 141: Sphinx Knowledge Graph Foundations** - Build SphinxAgent’s persistent graph store and typed threat-memory model.
- [ ] **Phase 142: Stigmergic Memory Queries And Fitness Retrieval** - Route knowledge lookups through pheromone queries and feed Sphinx-backed Q-values into Kitten fitness.
- [ ] **Phase 143: Knowledge Retention And Adversarial Corpus Adapter** - Add graph retention controls and the Rust-native adversarial scenario adapter.
- [ ] **Phase 144: Red-Blue Pressure And Episode Logging** - Fold adversarial pressure into evolution fitness and persist full red-blue episode history.
...
| 137. Kitten Mutation And Drift Orchestration | v1.42 | 0/1 | Planned | 2026-04-09 |
| 138. Fitness Evaluation And Population Persistence | v1.42 | 0/0 | Planned | — |
| 139. Formal Safety Gate And Canary Admission | v1.42 | 0/0 | Planned | — |
| 140. Evolution Observability And Operator Status | v1.42 | 0/0 | Planned | — |
| 141. Sphinx Knowledge Graph Foundations | v1.43 | 0/0 | Planned | — |
| 142. Stigmergic Memory Queries And Fitness Retrieval | v1.43 | 0/0 | Planned | — |
| 143. Knowledge Retention And Adversarial Corpus Adapter | v1.43 | 0/0 | Planned | — |
| 144. Red-Blue Pressure And Episode Logging | v1.43 | 0/0 | Planned | — |

---
*Last shipped milestone: v1.40 Killer Demo And Providence Integration on 2026-04-08*
*Active milestone: v1.42 Evolution Engine Core*
*Last updated: 2026-04-09 after completing Phase 136, closing v1.41, and preparing Phase 137 plan 01*
