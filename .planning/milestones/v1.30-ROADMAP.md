...
### v1.30 Structured Observability And Adapter Resilience (Complete)
...
- [x] **Phase 90: Structured Logging And Expanded Metrics** - Operations are traceable through correlation IDs and metrics cover all decision dimensions (completed 2026-04-05)
- [x] **Phase 91: Adapter Resilience And Operational Probes** - Response adapters handle transient failures gracefully, health probes separate readiness from liveness, and invalid config is rejected at load time (completed 2026-04-05)
...
Plans:
- [x] 90-01-PLAN.md -- Expand CriticalPathMetrics with counter families, thread correlation IDs through ingest, instrument service decision points, and initialize JSON subscriber
...
Plans:
- [x] 91-01-PLAN.md -- Retry with exponential backoff, circuit breaker, and dead-letter journal for HTTP EDR and webhook adapters
- [x] 91-02-PLAN.md -- /readyz and /livez Kubernetes probe endpoints, detector profile threshold validation on all 5 profiles
...
|-------|-----------|----------------|--------|-----------|
| 90. Structured Logging And Expanded Metrics | v1.30 | 1/1 | Complete | 2026-04-05 |
| 91. Adapter Resilience And Operational Probes | v1.30 | 2/2 | Complete | 2026-04-05 |

---
*Last shipped milestone: v1.30 Structured Observability And Adapter Resilience on 2026-04-05*
