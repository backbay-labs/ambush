...
- [x] **Phase 157: Calico Agent Core And Deception Playbook** - Implement CalicoAgent with honeypot service deployment and canary token placement driven by repo-owned YAML playbooks. (CALICO-01, CALICO-02) (completed 2026-04-09)
- [x] **Phase 158: Calico Lifecycle And Evolution Integration** - Manage decoy deploy/monitor/rotate/cleanup lifecycle, register decoys in Sphinx knowledge graph, and feed deception interactions into KittenAgent fitness. (CALICO-03, CALICO-04) (completed 2026-04-09)
- [x] **Phase 159: Fileless Execution Detection** - Add `FilelessExecutionDetector` for reflective DLL injection, encoded PowerShell, and syscall gadget patterns via new `ProcessMemoryAccess` telemetry payload. (FILELESS-01, FILELESS-03, FILELESS-05) (completed 2026-04-09)
- [x] **Phase 160: Behavioral Anomaly Baselines** - Add `BehavioralAnomalyDetector` with per-host process ancestry baselines, configurable decay, and substrate-backed persistence. (FILELESS-02, FILELESS-04, FILELESS-06) (completed 2026-04-09)
...
---
*Active milestone: v1.47 Calico And Detection Breadth (complete)*
*Next step: `$gsd-new-milestone`*
*Last updated: 2026-04-09 — Phases 159 and 160 completed; v1.47 closed*
