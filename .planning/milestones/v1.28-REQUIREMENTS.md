...
- [x] **SUB-01**: NATS JetStream pheromone substrate backend persists deposits across restarts

### Multi-Instance Coordination

- [x] **SUB-02**: Multiple swarm-detect instances contribute deposits to shared substrate with correct concentration aggregation
- [x] **SUB-03**: min_sources_for_escalation enforcement works correctly across multiple instances

### Legacy Cleanup

- [x] **CLEAN-01**: swarm-bridge (dead PyO3 shim) and kernel/ Python stubs are removed or archived
...
|-------------|-------|--------|
| SUB-01 | Phase 86 | Satisfied |
| SUB-02 | Phase 87 | Satisfied |
| SUB-03 | Phase 87 | Satisfied |
| CLEAN-01 | Phase 87 | Satisfied |
