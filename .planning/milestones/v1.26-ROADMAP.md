...
### v1.26 Detection Breadth And Telemetry Ingestion (Complete)
...
- [x] **Phase 81: Detection Strategy Expansion** - Four new detectors covering DNS exfiltration, lateral movement, credential access, and suspicious scripting, with MITRE ATT&CK-tagged scenario fixtures (completed 2026-04-05)
- [x] **Phase 82: Telemetry Ingest Server** - HTTP POST JSON ingest endpoint in swarm-detect with normalization and validation (completed 2026-04-05)
- [x] **Phase 83: Tetragon Bridge Port** - gRPC bridge crate consuming Tetragon kernel-level process telemetry into normalized TelemetryPayload (completed 2026-04-05)
...
Plans:
- [x] 81-01-PLAN.md -- Extend TelemetryPayload with new event types and create four detector modules with unit tests
- [x] 81-02-PLAN.md -- Wire detectors into runtime, create MITRE-tagged scenario fixtures and integration tests
...
Plans:
- [x] 82-01-PLAN.md -- Ingest module, handler, swarm-detect --serve mode, integration tests
...
Plans:
- [x] 83-01-PLAN.md -- swarm-ingest-tetragon crate with proto compilation, gRPC client, event mapper, and bridge event loop
...
|-------|-----------|----------------|--------|-----------|
| 81. Detection Strategy Expansion | v1.26 | 2/2 | Complete | 2026-04-05 |
| 82. Telemetry Ingest Server | v1.26 | 1/1 | Complete | 2026-04-05 |
| 83. Tetragon Bridge Port | v1.26 | 1/1 | Complete | 2026-04-05 |

---
*Roadmap created: 2026-04-05 for milestone v1.26*
*Archived: 2026-04-05*
