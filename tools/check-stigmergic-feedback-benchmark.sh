...
# STS_STIGMERGIC_BASELINE_FILE repoints the baseline this gate compares against. It is a
# REGENERATION hook, not a bypass: nothing in CI sets it, so a workflow run
# always compares against the checked-in docs/benchmarks/stigmergic-feedback-baseline.json.
