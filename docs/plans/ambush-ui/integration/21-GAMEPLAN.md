...
4. **Assurance as the floor**, interleaved — phase 285 (assumption registry and invariant
   map) **LANDED** (`79840eb4d`, 2026-09-07); then 286 (deterministic simulation testing),
   287 (fuzz, loom, supply chain), 292 (pure decision core), 293 (Kani), 294 (named safety
   properties and the partition-lease model).
