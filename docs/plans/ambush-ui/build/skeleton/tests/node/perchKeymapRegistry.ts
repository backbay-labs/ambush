// Target path in BUZZ: desktop/src/features/perch/lib/perchKeymapRegistry.ts
//
...
//   - `AMB tools/check-copy-banned-terms.sh`'s keymap pass, which parses the
...
//
// STATUS: PROPOSED. No `features/perch` directory exists in block/buzz at
// eed74bde2. Every value below is transcribed from APPENDIX-NORMATIVE.md
// section 2, which is normative; nothing here is invented.
...
export const PERCH_BINDINGS: readonly PerchBinding[] = [
  ...
  { key: "D", rowTypes: ["finding"], verb: "dismiss", meaning: "Dismiss — two-stage" },
  { key: "I", rowTypes: ["finding"], verb: "investigate", meaning: "Investigate" },
  { key: "G", rowTypes: ["hold"], verb: "grant", meaning: "Arms the grant; Enter records it" },
  { key: "R", rowTypes: ["hold"], verb: "refuse", meaning: "Refuse — one keypress, no dialog, no undo" },
  { key: "S", rowTypes: ["finding", "case"], disabledOn: ["hold"], meaning: "Snooze" },
  { key: "E", rowTypes: ["finding", "hold", "lane"], meaning: "Promote to a case" },
  { key: "J", rowTypes: ["finding", "hold", "case", "lane", "containment"], meaning: "Move selection down" },
  { key: "K", rowTypes: ["finding", "hold", "case", "lane", "containment"], meaning: "Move selection up" },
  { key: "M", rowTypes: ["finding", "hold", "case", "lane", "containment"], meaning: "Mark done — local only, never a decision record" },
  { key: "U", rowTypes: ["finding", "hold", "case", "lane", "containment"], meaning: "Mark unread — local only, never a decision record" },
