...
- **No comparison to existing systems**: The academic references include HOLMES, UNICORN, SLEUTH, and ATLAS -- all of which have published evaluation results on public datasets. Doc 05 should compare its proposed approach against these published baselines to establish whether the Ambush graph correlator will be competitive.
