...
```python
from swarm_platform_client import Client
...
```python
from swarm_platform_client import AuthenticatedClient
...
```python
from swarm_platform_client.models import MyDataModel
from swarm_platform_client.api.my_tag import get_my_data_model
from swarm_platform_client.types import Response
...
1. Any endpoint which did not have a tag will be in `swarm_platform_client.api.default`
